...
namespace Assignment1
{
    public class PlayerMovement : PlayerScript, InputReceiver
    {
        ...
        public void DoMoveDir(Vector2 aDir)
        {
            ...
            //TASK 1b START
            GetComponent<Rigidbody2D>().MovePosition(transform.position + ((Vector3)moveDir * moveSpeed * Time.fixedDeltaTime));
            //TASK 1b END
            ...
            //Reference https://answers.unity.com/questions/640821/rotate-objects-local-up-towards-a-vector.html
            //TASK 1c END
        }
